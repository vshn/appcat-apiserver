...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VSHNMariaDBSizeSpec) DeepCopyInto(out *VSHNMariaDBSizeSpec) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VSHNMariaDBSizeSpec.
func (in *VSHNMariaDBSizeSpec) DeepCopy() *VSHNMariaDBSizeSpec {
	if in == nil {
		return nil
	}
	out := new(VSHNMariaDBSizeSpec)
	in.DeepCopyInto(out)
	return out
}
