...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/vshn/appcat-apiserver/apis/appcat/v1.AppCat":                   schema_appcat_apiserver_apis_appcat_v1_AppCat(ref),
		"github.com/vshn/appcat-apiserver/apis/appcat/v1.AppCatList":               schema_appcat_apiserver_apis_appcat_v1_AppCatList(ref),
		"github.com/vshn/appcat-apiserver/apis/appcat/v1.AppCatStatus":             schema_appcat_apiserver_apis_appcat_v1_AppCatStatus(ref),
		"github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNMariaDBBackup":        schema_appcat_apiserver_apis_appcat_v1_VSHNMariaDBBackup(ref),
		"github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNMariaDBBackupList":    schema_appcat_apiserver_apis_appcat_v1_VSHNMariaDBBackupList(ref),
		"github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNMariaDBBackupStatus":  schema_appcat_apiserver_apis_appcat_v1_VSHNMariaDBBackupStatus(ref),
		"github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNPlan":                 schema_appcat_apiserver_apis_appcat_v1_VSHNPlan(ref),
		"github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNPostgresBackup":       schema_appcat_apiserver_apis_appcat_v1_VSHNPostgresBackup(ref),
		"github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNPostgresBackupList":   schema_appcat_apiserver_apis_appcat_v1_VSHNPostgresBackupList(ref),
		"github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNPostgresBackupStatus": schema_appcat_apiserver_apis_appcat_v1_VSHNPostgresBackupStatus(ref),
		"github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNRedisBackup":          schema_appcat_apiserver_apis_appcat_v1_VSHNRedisBackup(ref),
		"github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNRedisBackupList":      schema_appcat_apiserver_apis_appcat_v1_VSHNRedisBackupList(ref),
		"github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNRedisBackupStatus":    schema_appcat_apiserver_apis_appcat_v1_VSHNRedisBackupStatus(ref),
		"github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNSize":                 schema_appcat_apiserver_apis_appcat_v1_VSHNSize(ref),
...
func schema_appcat_apiserver_apis_appcat_v1_AppCat(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
			...
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
						...
						SchemaProps: spec.SchemaProps{
							...
							AdditionalProperties: &spec.SchemaOrBool{
								...
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNPlan"),
									},
								},
							},
						},
					...
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/vshn/appcat-apiserver/apis/appcat/v1.AppCatStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/vshn/appcat-apiserver/apis/appcat/v1.AppCatStatus", "github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNPlan", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_appcat_apiserver_apis_appcat_v1_AppCatList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/vshn/appcat-apiserver/apis/appcat/v1.AppCat"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/vshn/appcat-apiserver/apis/appcat/v1.AppCat", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_appcat_apiserver_apis_appcat_v1_AppCatStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_appcat_apiserver_apis_appcat_v1_VSHNMariaDBBackup(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNMariaDBBackupStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNMariaDBBackupStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_appcat_apiserver_apis_appcat_v1_VSHNMariaDBBackupList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNMariaDBBackup"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNMariaDBBackup", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_appcat_apiserver_apis_appcat_v1_VSHNMariaDBBackupStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_appcat_apiserver_apis_appcat_v1_VSHNPlan(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"size": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNSize"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNSize"},
	}
}

func schema_appcat_apiserver_apis_appcat_v1_VSHNPostgresBackup(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"status": {
						SchemaProps: spec.SchemaProps{
							...
							Default:     map[string]interface{}{},
							Ref:         ref("github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNPostgresBackupStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNPostgresBackupStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_appcat_apiserver_apis_appcat_v1_VSHNPostgresBackupList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNPostgresBackup"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNPostgresBackup", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_appcat_apiserver_apis_appcat_v1_VSHNPostgresBackupStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
...
func schema_appcat_apiserver_apis_appcat_v1_VSHNRedisBackup(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
				Properties: map[string]spec.Schema{
					...
					"status": {
						SchemaProps: spec.SchemaProps{
							Default: map[string]interface{}{},
							Ref:     ref("github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNRedisBackupStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNRedisBackupStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_appcat_apiserver_apis_appcat_v1_VSHNRedisBackupList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
						...
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Default: map[string]interface{}{},
										Ref:     ref("github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNRedisBackup"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/vshn/appcat-apiserver/apis/appcat/v1.VSHNRedisBackup", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}

func schema_appcat_apiserver_apis_appcat_v1_VSHNRedisBackupStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
...
func schema_appcat_apiserver_apis_appcat_v1_VSHNSize(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
